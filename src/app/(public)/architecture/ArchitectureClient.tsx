    ...
    <div>
      ...
      <section className="bg-secondary">
              ...
              >
                <Link href={`/portfolio/${project.slug}`} className="group block">
                  <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                    {project.cover_image ? (
                      <img src={project.cover_image} alt={project.title} className="absolute inset-0 w-full h-full object-cover group-hover:group-active:scale-105 transition-transform duration-700" />
                    ) : (
                    ...
                    <div className="absolute top-4 right-4 hidden sm:block opacity-0 group-hover:group-active:opacity-100 transition-opacity duration-500">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 text-center">
          <Link href="/portfolio?filter=architecture" className="group inline-flex items-center gap-3 px-8 py-4 border border-white/20 text-white text-sm font-medium tracking-wide hover:bg-white hover:text-secondary active:bg-white active:text-secondary transition-all duration-300 hover:active:scale-105">
            {t('common.seeAll')} <ArrowRight className="w-4 h-4 group-hover:group-active:translate-x-1 transition-transform" />
          </Link>
        </div>
      </section>
      ...
      <section className="py-32 lg:py-40 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            <Link href={cta.btn_href} className="group inline-flex items-center gap-3 px-8 py-4 border border-white text-white text-sm font-medium tracking-wide hover:bg-white hover:text-primary active:bg-white active:text-primary transition-all duration-300 hover:active:scale-105">
              {cta.btn_text} <ArrowRight className="w-4 h-4 group-hover:group-active:translate-x-1 transition-transform" />
            </Link>
          </motion.div>
        </div>
      </section>
